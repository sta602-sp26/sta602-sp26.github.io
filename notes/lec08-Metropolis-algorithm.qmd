...
Some terminology that will be useful in the future: $Y|X \sim Poisson(e^{\beta^T \mathbf{x}})$ is "Poisson regression". Where $\beta^T \mathbf{x} = \beta_1 + \beta_2 x + \beta_3 x^2$.\
