...
Watch the video [here](https://www.iris.edu/hq/inclass/animation/1component_seismogram_building_responds_to_p_s_surface_waves) to see the data that InSight collects from marsquakes.
...
Here our parameter vector $\theta = (\alpha, \phi, \gamma_w, \kappa_m, \mu_m, \rho_m)$. These parameters describe the medium through which the marsquake waves propagate.
